...
step2_Agricultural_Biodiversity <- function(){
  ...
  if (cfg$BiodiversityIndicator == "old"){
  ...
  else if (cfg$BiodiversityIndicator == "new"){
...
all_TAPE <- function(){
  ...
  ## Agrobiodiversity
  if (cfg$BiodiversityIndicator == "new") {
    TAPE_final <- TAPE_final %>%
  ...
  }else if (cfg$BiodiversityIndicator == "old") {
    TAPE_final <- TAPE_final %>%
      left_join(Agricultural_biodiversity[c( 'key' ,'Agricultural_diversity_old','GSIndex_crops', 'GSIndex_animals', 'GSI_other')], by = 'key')
  }
  ...
  if (cfg$BiodiversityIndicator == "new") {
    TAPE_final_Excel <- TAPE %>%
      rename("Region, Province" = "location1",
             ...
             'Womens Empowerment' = "wemp_score")  }else if (cfg$BiodiversityIndicator == "old") {
               TAPE_final_Excel <- TAPE %>%
                 rename("Region, Province" = "location1",
                        "Municipality, District" = "location2",
                        "Name of the system" = "sys_name",
                        ...
                        Landtenure = "landtenure",
                        'Exposure to Pesticides' = "pest_score",
                        'Biodiversity Indicator' = "Agricultural_diversity_old",
